const translations = {
  ...
  "Could not load shipment details.": "无法加载出货详情。",
  ...
  "Lineage": "Lineage",
  "Sing Long": "成龙",
  "LI CHUAN FOOD PRODUCTS PTE LTD": "立川食品有限公司",
  "Total Product": "产品总数",
  "Total Stock": "库存总量",
  "Total": "总计",
  "CR 5": "CR 5",
  ...
  "Shipment List": "出货列表",
  "Shipment Upload": "上传出货",
  "Shipment Allocation": "出货分配",
  "Upload Shipment File": "上传出货文件",
  ...
  "Allocate Shipment": "分配出货",
  "Select an Excel file to allocate a shipment.": "请选择 Excel 文件进行出货分配。",
